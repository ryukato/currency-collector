...
public class JsoupCurrencyListCollectorTest {
    ...
    public void collectTest_with_invalid_url() {
        CurrencyListCollector.Config invalidUrlConfig = CurrencyListCollector.Config.emptyHeaderParamsConfig("invalid url");
        try {
    ...
    public void collectTest_with_not_reachable_url() {
        CurrencyListCollector.Config invalidUrlConfig = CurrencyListCollector.Config.emptyHeaderParamsConfig("http://not-reachable.com");
        try {
            collector.collect(invalidUrlConfig);
            fail();
        }catch (InvalidCollectConfigurationException e) {
    ...
    public void collectTest_with_empty_url() {
        CurrencyListCollector.Config urlEmptyConfig = CurrencyListCollector.Config.emptyHeaderParamsConfig(null);
        try {
